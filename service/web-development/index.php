      ...
      <section class="aboutus-section">
        <div class="aboutus-container">
          <div class="aboutus-content">
            ...
            <p>
              Entering the digital marketplace and in need of a website? When you work with our top-tier website design
              and development agency, you can be certain that you will get the most engaging and visually appealing
              websites possible. Experienced candidates on our team have mastered the art of creating a website design
              that is perfect for your company. As a result, it not only gains the confidence of your target audience
              but also provides valuable insight into your rivals' actions. We have been in the website design business
              for ages and have never had a single customer complaint.
            </p>
            <p>
              Our service is completely open, and as a client, you have total control over the site creation process.
              Our goal is to provide you the finest services and investments possible. Our mission is to make sure your
              website continues to be strong and promotes your name. We are available to support you at any point along
              the process, from the start to finish, with the website or any changes or additions you may want to make
              to it. In a nutshell, Tecknify IT Solutions is a hub that can fix any issues you're having with site
              design.
            </p>
            <!-- <p>
      ...
      <section class="our-service-section">
        ...
        <div class="our-service-grid">
          ...
          <div class="our-service-card">
            ...
            <h2>Testing</h2>
            <p style="text-align: justify;">
              During the testing phase, we rigorously check the technical aspects of the site. Thus, ensuring that code
              and scripts are compatible across all major browsers. We also ask the crucial question: does the website
              truly fulfil its purpose, meeting both user needs and business objectives.
            </p>
          </div>
          <div class="our-service-card">
            <div class="our-service-icon">
          ...
          <ul class="grid-list">
            ...
            <li>
              <div class="faq-card">
                ...
                <div class="card-content">
                  <p>
                    Yes! To ensure your website is up to date, secure and responsive we also provide maintenance
                    services in the long run. This comprises of products such as bug fixes, content updates, increased
            ...
            <li>
              <div class="faq-card">
                ...
                <div class="card-content">
                  <p>
                    Absolutely! Our services primarily focus on updating old websites by enhancing the visual look and
                    feel and usability of the site. We collaborate with your specific needs to guarantee the new design
                    will convey your company image and mission. How will my website be designed for the mobile users?
                  </p>
                </div>
            ...
            <li>
              <div class="faq-card">
                ...
                <div class="card-content">
                  <p>
                    Yes! every site we design is absolutely responsive, which means it will look good and work correctly
                    on PCs, tablets and mobiles.
                  </p>
                </div>
            ...
            <li>
              <div class="faq-card">
                ...
                <div class="card-content">
                  <p>
                    Yes, we do specialize in creating e-shopping sites that will suit your business purpose. We can
                    contribute smooth payment methods, product interfaces, plus other fortuitous components to assist
                    you in setting up a profitable online store.
                  </p>
                </div>
            ...
            <li>
              <div class="faq-card">
                ...
                <div class="card-content">
                  <p>
                    Depending on the site, we can incorporate third-party applications and API to its functionalities as
                    like payment gateway, CRM, social media feeds, marketing tools etc.
                  </p>
                </div>
