    ...
    <article>
      ...
      <section class="aboutus-section">
        <div class="aboutus-container">
          <div class="aboutus-content">
            ...
            <p>
              Looking to bring your app idea to life? You've come to the right place with Tecknify IT Solutions. Whether
              you're launching a new app or enhancing an existing one, our top-tier App Development services are here to
              guide you every step of the way. Perhaps you've already worked with other developers and found the results
              lacking? The success of app development relies on a combination of the right tools, expertise, and
              strategic planning. Our skilled team is committed to utilizing cutting-edge technologies and crafting
              tailor-made solutions that align with your business goals.
            </p>
            <p>
              With producing quality output, we do it within the standard and do it beyond your expectations. It also
              means that your app will be built by our team of developers to be not only easy to use and navigate but
              also fast and efficient. Being launched in 2014, Tecknify already has dozens of satisfied clients and a
              solid base of perfected applications. It is therefore our policy to be very meticulous at every phase of
              development process from the time the idea is conceived to the actual launch.
            </p>
            <p>
        ...
        <div class="our-service-grid">
          <div class="our-service-card">
            ...
            <p style="text-align: justify;">
              Our primary goal is to keep the user engaging and to make sure your app is intuitive and compelling for
              the user.
            </p>
          </div>
          <div class="our-service-card">
            ...
            <p style="text-align: justify;">
              All our apps can be integrated to your business, allowing for ease of expansion of your business to
          ...
          <div class="our-service-card">
            ...
            <p style="text-align: justify;">
              Using our effective development process, we make your app reach markets faster so that it can compete with
              other apps.
            </p>
          </div>
          <div class="our-service-card">
            ...
            <p style="text-align: justify;">
              Once your app has been developed, we provide support in terms of maintenance and application of new
              features to your app to make it relevant.
            </p>
          </div>
          <!-- <div class="our-service-card">
            <div class="our-service-icon">
      ...
      <section class="industries-section">
        <div class="industries-content">
          ...
          <p style="text-align: justify;">
            In Tecknify IT Solutions, we have innovative and strategic services in App Development to address the needs
            of sectors such as retail, e-commerce, healthcare, legal, financial, education, property, technology and
            many others. Our developers create and implement appropriately targeted apps with the highest performance
            characteristics that echo the vision and objectives of your business whilst bringing in increased revenue
            and facilitating greater customer satisfaction across the board.
          </p>
          ...
          <ul class="grid-list">
            ...
            <li>
              <div class="faq-card">
                ...
                <div class="card-content">
                  <p>
                    Tecknify focuses specifically on the creation of mobile applications for the iOS and Android
                    platform, as well as a combination of both. If you don’t need a native app, or if you’re looking for
                    a hybrid solution, we have the experience to design the right app for you.
                  </p>
                </div>
            ...
            <li>
              <div class="faq-card">
                ...
                <div class="card-content">
                  <p>
                    Our development process therefore involves testing phases in order to pin point any problem that may
                    be faced during the initial stages of the product launch. These aspects help us to guarantee that
                    your app is fast, safe, and meets the needs of users.
                  </p>
                </div>
            ...
            <li>
              <div class="faq-card">
                ...
                <div class="card-content">
                  <p>
                    Concerning the timelines for application development, it cannot be measured in a number of weeks or
                    months because app development depends on your project’s complexity and the application’s scope. In
                    most cases, the total recovery period can range between several weeks to several months. We offer an
                    outlined timeline from the beginning to make sure you know exactly when we will deliver your order.
                  </p>
                </div>
            ...
            <li>
              <div class="faq-card">
                ...
                <div class="card-content">
                  <p>
                    After making an application, we offer ongoing support and maintenance services. We manage update and
                    maintain fresh appearance with fine performance for the new improving and features that you may get
                    from the feedback of your end users.
                  </p>
                </div>
            ...
            <li>
              <div class="faq-card">
                ...
                <div class="card-content">
                  <p>
                    It is an app designed directly for a given operating system (iOS or Android) and performs well while
                    providing access to device functions. A hybrid app can be best described as an app that is developed
                    once and may be deployed on more than one platform. The right choice depends whether on the
                    complexity of your project or how deep your pockets are.
                  </p>
                </div>
