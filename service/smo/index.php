...
<head>
  ...
  <link rel="stylesheet" href="<?php echo $tecknify ?>service/smo/style.css">
...
<script>
      ...
      <section class="aboutus-section">
        <div class="aboutus-container">
          <div class="aboutus-content">
            ...
            <p>
              Become viral on social media by increasing the number of engagements you have, and translate the reach
              into potential customers who are eager to try your products and services. Does that seem like something
              out of a story? That is no longer the case because you are now working with the best social media
              marketing company, which has the ability to generate a large response from your social media advertising
              efforts.
            </p>
            <p>
              At tecknify.com, we have a team that is solely devoted to each of the services that we offer. A vast
              majority of the audience is actively participating on the internet, and especially on social media. In
              today's world, social media platforms itself serve as the hub for viewers and customers. It operates in a
              very straightforward manner. While you are showcasing your goods, the person who is interested will
              purchase it.
            </p>
            <p>
              The best social media marketing services are provided by us, and they are designed to assist your company
              in expanding the reach of your social media postings and attracting a larger audience to your website. On
              the other hand, we do not believe in providing service just once. Rather, we believe in creating a
              committed audience that will remain loyal to you for an extended period of time and will also become your
              trusted clients. What sets us apart from other companies in the market is this particular aspect.
            </p>
          </div>
        ...
        <div class="our-service-grid">
          ...
          <div class="our-service-card">
            ...
            <p style="text-align: justify;">
              ...
              across a variety of media channels such as Facebook, Twitter and YouTube among others. But it does not end
              there, your brand can also do well at visually centric networks like Pinterest, Flickr, and Instagram, all
              fine-tuned for getting the most for your brand.
            </p>
          </div>
          <!-- <div class="our-service-card">
            <div class="our-service-icon">
          ...
          <ul class="grid-list">
            ...
            <li>
              <div class="faq-card">
                ...
                <div class="card-content">
                  <p>
                    A verified and active SMM can assist brands create brand awareness, cultivate customer relationships
                    and channel targeted traffic to one’s site. It is a successful method to reach a vast, wider
                    audience with even better intents and purposes in developing your company.
                  </p>
                </div>
            ...
            <li>
              <div class="faq-card">
                ...
                <div class="card-content">
                  <p>
                    No specific timeline is given as the matter depends on the objective of the project, type of
                    business, and market challenges. Usually, the first positive results the website’s owner can observe
                    work within 3 to 6 months providing a consistent activity.
                  </p>
                </div>
            ...
            <li>
              <div class="faq-card">
                ...
                <div class="card-content">
                  <p>
                    The platforms which are best for your business depend with the type/segment of the market you are
                    in. We assist in identifying relevant platforms if you’re unclear as to which would be appropriate;
                    for example, is it Instagram, Facebook, LinkedIn, Twitter, or others depending on the strategy and
                    company type.
                  </p>
                </div>
            ...
            <li>
              <div class="faq-card">
                ...
                <div class="card-content">
                  <p>
                    The Key Performance Indicators (KPI) includes engagement rates and web traffic, conversion and
                    follower growth among the target audience. We make it our responsibility to give accounts of the
                    progress, or the results which can help in tweaking efforts for better outcome.
                  </p>
                </div>
            ...
            <li>
              <div class="faq-card">
                ...
                <div class="card-content">
                  <p>
                    Yes, we offer content creation services where you can request posts, graphics, videos and much more.
                    While working with our team, all the content will maintain your brand’s voice and meet its
                    objectives and appeal to your target audience.
                  </p>
                </div>
  ...
  <!-- 
    - custom js link
  -->
  <script src="<?php echo $tecknify ?>service/smo/script.js"></script>
